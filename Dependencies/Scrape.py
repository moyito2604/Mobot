# ALL OF THIS CODE IS FROM DERAMASMID/SCRAPETUBE BUT IS TEMPORARILY BEING USED FOR METADATA EXTRACTION
# WHEN A NEW VERSION OF SCRAPETUBE IS AVAILABLE, THIS WILL BE SCRAPPED.
