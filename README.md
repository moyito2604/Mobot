...
The music portion of the bot requires a couple dependencies to run properly as it utilizes **yt_dlp, nextcord, and ffmpeg** to process the audio that is recieved through the bot. 
